...
│           └── responses/ # Response serialization
│
├── models/                 # ODMantic database models
│   └── user_model.py
│
...
| POST | `/send-verification` | Resend verification | ✅ |
...
### 🔲 Phase 2: Cleaner Profiles (Coming Soon)
- [ ] Cleaner profile model
- [ ] Service packages model
- [ ] Cleaner CRUD operations
- [ ] Service CRUD operations
- [ ] Cleaner search endpoints
- [ ] Location-based search

### 🔲 Phase 3: Booking System (Coming Soon)
- [ ] Booking model
- [ ] Booking workflow
- [ ] Availability management
- [ ] Booking status updates

### 🔲 Phase 4: Reviews & Ratings (Coming Soon)
- [ ] Review model
- [ ] Review submission
- [ ] Rating calculations
